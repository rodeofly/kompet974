...
(function() {
  var DATA, DATA_TEMP, ELEVES, EVALS, HEADERS, ID, arrayToTable, bigTable, l, len, o, select_kid, tableToJson, toggleEval;
  ...
  $(function() {
    ...
    $("#letter").change(function() {
      var CLASSE, len3, letter, r, table;
      letter = $("#letter").val();
      if (letter !== " ") {
